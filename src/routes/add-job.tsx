...
export function AddJobRoute() {
	return (
		<div>
			<h1 className="font-bold text-2xl text-center">Create Job</h1>
			<Form method="post" className="max-w-md mx-auto">
				...
				<div className="relative z-0 w-full mb-5 group">
					<select className="block py-2.5 px-0 w-full text-md text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer">
						<option value="false">In Progres</option>
						<option value="false">Stil Running</option>
